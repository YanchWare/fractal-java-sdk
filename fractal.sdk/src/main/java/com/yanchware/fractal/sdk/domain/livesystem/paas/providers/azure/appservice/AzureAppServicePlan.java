...
public class AzureAppServicePlan extends AzureResource implements Validatable {
  ...
  private final static String NAME_NOT_VALID = "[AzureAppServicePlan Validation] The name only allow alphanumeric " +
    "characters and hyphens, cannot start or end in a hyphen, and must be less than or equal to 40 characters";
  ...
  public static class AzureAppServicePlanBuilder extends AzureResource.Builder<AzureAppServicePlanBuilder> {
    ...
    /**
     * App Service plan pricing tier determines the location, features, cost and compute resources associated with
     * your app.
     */
