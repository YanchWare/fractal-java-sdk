...
public class ComponentId {
  ...
  protected final static String ID_NULL_OR_EMPTY_TEMPLATE = "Component id '%s' is illegal. A valid component id " +
    "cannot be null, empty or contain spaces";
  protected final static String ILLEGAL_ID_TEMPLATE = "Component id '%s' is illegal. A valid component id must start " +
    "with a lowercase character and it can only contain lowercase characters, digits and hyphens";
