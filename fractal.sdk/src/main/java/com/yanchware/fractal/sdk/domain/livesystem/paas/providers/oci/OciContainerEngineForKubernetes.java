...
public class OciContainerEngineForKubernetes extends KubernetesCluster implements OciResourceEntity {
  private final static String REGION_IS_NULL = "[OciContainerEngineForKubernetes Validation] Region is not specified " +
    "and it is required";
  ...
  public static class OciContainerEngineForKubernetesBuilder extends Builder<OciContainerEngineForKubernetes,
    OciContainerEngineForKubernetesBuilder> {
