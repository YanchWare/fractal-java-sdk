...
@Data
@ToString
public class AwsAccountInitializationRequest {
  public UUID tenantId;
  public UUID subscriptionId;
  public String region;
  public Map<String, String> tags;

  public static AwsAccountInitializationRequest fromEnvironment(Environment environment) {
    var command = new AwsAccountInitializationRequest();
