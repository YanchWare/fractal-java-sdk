...
public class ComponentId {
  ...
  protected final static String ID_TOO_LONG_TEMPLATE = "Component id %s is illegal. A valid component Id must be between 3 and 15 characters of length";
  ...
  public static Collection<String> Validate(String value) {
    ...
    if (value.length() < 3 || value.length() > 15) {
      ret.add(String.format(ID_TOO_LONG_TEMPLATE, value));
    }
