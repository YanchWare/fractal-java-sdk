...
public class AzureVirtualMachine extends IaaSVirtualMachine implements AzureResourceEntity, LiveSystemComponent {
    ...
    private final static String MISSING_ROOT_SECRET = "[AzureVirtualMachine validation] Either Root password or Root SSH Public" +
    ...
    public static class AzureVirtualMachineBuilder extends Component.Builder<AzureVirtualMachine, AzureVirtualMachine.AzureVirtualMachineBuilder> {
        @Override
