...
public class Compartment implements Validatable {
  ...
  @JsonIgnore
  public static final String NAME_IS_NOT_VALID = "[OCI Compartment Validation] Name can only include alphanumeric, " +
    "underscore, parentheses, hyphen, period (except at end), and Unicode characters that match the allowed characters";
