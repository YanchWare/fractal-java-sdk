...
public enum ComponentType {
  ...
  PAAS_STREAMING("Messaging.PaaS.Streaming"),
  PAAS_MESSAGE_ENTITY("Messaging.PaaS.Entity"),
  PAAS_STREAMING_ENTITY("Messaging.PaaS.StreamingEntity"),
  PAAS_SERVICE_BUS_NAMESPACE("Messaging.PaaS.ServiceBus"),
  PAAS_EVENTHUB_NAMESPACE("Messaging.PaaS.EventhubNamespace"),
  PAAS_EVENTHUB_INSTANCE("Messaging.PaaS.EventhubInstance"),
  ...
  SAAS_UNMANAGED_SECURITY("Security.SaaS.Unmanaged"),
