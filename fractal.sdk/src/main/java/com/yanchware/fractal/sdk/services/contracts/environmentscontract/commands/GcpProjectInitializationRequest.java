...
@Data
@ToString
public class GcpProjectInitializationRequest {
  public UUID tenantId;
  public UUID subscriptionId;
  public String region;
  public Map<String, String> tags;

  public static GcpProjectInitializationRequest fromEnvironment(Environment environment) {
    var command = new GcpProjectInitializationRequest();
