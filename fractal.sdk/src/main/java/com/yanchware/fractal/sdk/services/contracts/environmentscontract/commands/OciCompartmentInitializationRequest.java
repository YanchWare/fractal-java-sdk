...
@Data
@ToString
public class OciCompartmentInitializationRequest {
  public UUID tenantId;
  public UUID subscriptionId;
  public String region;
  public Map<String, String> tags;

  public static OciCompartmentInitializationRequest fromEnvironment(Environment environment) {
    var command = new OciCompartmentInitializationRequest();
