...
public class GcpPostgreSqlDbms extends PaaSPostgreSqlDbms {
  ...
  private final static String REGION_IS_NULL = "[GcpProgreSQL Validation] Region has not been defined and it is " +
    "required";

  private final static String NETWORK_IS_NULL_OR_EMPTY = "[GcpProgreSQL Validation] Network has not been defined and " +
    "it is required";

  private final static String PEERING_NETWORK_ADDRESS_IS_EMPTY = "[GcpProgreSQL Validation] Peering network address " +
    "is empty";

  private final static String PEERING_NETWORK_ADDRESS_DESCRIPTION_IS_EMPTY = "[GcpProgreSQL Validation] Peering " +
    "network address description is empty";

  private final static String PEERING_NETWORK_NAME_IS_EMPTY = "[GcpProgreSQL Validation] Peering network name is empty";

  private final static String PEERING_NETWORK_PREFIX_IS_EMPTY = "[GcpProgreSQL Validation] Peering network prefix is " +
    "empty";
