...
public enum ComponentType {
    ...
    PAAS_QUEUE("Messaging.PaaS.BrokerQueue"),
    PAAS_TOPIC("Messaging.PaaS.BrokerTopic"),
    PAAS_SERVICE_BUS_NAMESPACE("Messaging.PaaS.ServiceBusNamespace"),
    PAAS_SERVICE_BUS_RELAY("Messaging.PaaS.ServiceBusRelay"),
