...
import com.yanchware.fractal.sdk.domain.livesystem.caas.Toleration;
...
public abstract class CaaSComponent extends Component {
  ...
  public static abstract class Builder<T extends CaaSComponent, B extends Builder<T, B>> extends Component.Builder<T,
    B> {
     ...
     * @important.note <strong>Customizing resource management values offers flexibility, but you need to carefully
     * consider
     ...
     * @important.note <strong>Node selectors provide powerful control over pod scheduling, but incorrect or overly
     * restrictive
     ...
     * @important.note <strong>Toleration configurations must be carefully crafted to ensure compatibility with
     * cluster taints.
