...
public class DnsMxRecordData implements Validatable {
  private final String PRIORITY_NOT_VALID = "The Priority value must be between 0 and 65535";
  private final String MAIL_EXCHANGE_NOT_VALID = "The mailExchange value, concatenated with its zone name, must contain no more than 253 characters, excluding a trailing period. It must be between 2 and 34 labels. Each label must only contain letters, numbers, underscores, and/or dashes. Each label should be separated from other labels by a period. Each label must contain between 1 and 63 characters.";
  private final String MAIL_EXCHANGE_LABEL_NOT_VALID = "The mailExchange label must contain between 1 and 63 characters";
  private final String MAIL_EXCHANGE_NOT_DEFINED = "The mailExchange has not been defined and it is required";
  ...
  public Collection<String> validate() {
    ...
    if(StringUtils.isBlank(mailExchange)) {
      ...
      var hasValidCharacters = isValidLettersNumbersUnderscoresDashesAndPeriods(mailExchange);
