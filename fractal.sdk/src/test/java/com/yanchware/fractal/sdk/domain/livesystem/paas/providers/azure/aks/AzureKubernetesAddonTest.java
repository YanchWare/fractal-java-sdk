...
class AzureKubernetesAddonTest {
  ...
  public void shouldReturnProperValue() {
    assertAll(
      () -> assertEquals(AzureKubernetesAddon.fromString("httpApplicationRouting"),
        AzureKubernetesAddon.HTTP_APPLICATION_ROUTING),
      ...
      () -> assertEquals(AzureKubernetesAddon.fromString("ingressApplicationGateway"),
        AzureKubernetesAddon.INGRESS_APPGW),
      ...
      () -> assertEquals(AzureKubernetesAddon.fromString("webAppRouting"),
        AzureKubernetesAddon.WEB_APPLICATION_ROUTING));
  }
