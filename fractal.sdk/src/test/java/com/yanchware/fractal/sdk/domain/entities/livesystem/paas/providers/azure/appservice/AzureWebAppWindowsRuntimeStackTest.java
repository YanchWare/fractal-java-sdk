...
class AzureWebAppWindowsRuntimeStackTest {
  ...
  public void shouldReturnProperValue() {
    assertAll(
        () -> assertEquals(AzureWebAppWindowsRuntimeStack.fromString("dotnet|v8.0"), AzureWebAppWindowsRuntimeStack.DOTNET_8),
        ...
        () -> assertEquals(AzureWebAppWindowsRuntimeStack.fromString("NODE|20LTS"), AzureWebAppWindowsRuntimeStack.NODE_20_LTS),
        ...
        () -> assertEquals(AzureWebAppWindowsRuntimeStack.fromString("java|1.8|TOMCAT|10.1"), AzureWebAppWindowsRuntimeStack.JAVA_8_TOMCAT_10_1),
        ...
        () -> assertEquals(AzureWebAppWindowsRuntimeStack.fromString("java|11|TOMCAT|10.1"), AzureWebAppWindowsRuntimeStack.JAVA_11_TOMCAT_10_1),
        ...
        () -> assertEquals(AzureWebAppWindowsRuntimeStack.fromString("java|17|TOMCAT|10.1"), AzureWebAppWindowsRuntimeStack.JAVA_17_TOMCAT_10_1),
