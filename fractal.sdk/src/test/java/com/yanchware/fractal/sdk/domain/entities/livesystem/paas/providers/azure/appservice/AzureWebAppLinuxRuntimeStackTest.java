...
class AzureWebAppLinuxRuntimeStackTest {
  ...
  public void shouldReturnProperValue() {
    assertAll(
        () -> assertEquals(AzureWebAppLinuxRuntimeStack.fromString("DOTNETCORE|8.0"), AzureWebAppLinuxRuntimeStack.DOTNET_CORE_8_0),
        ...
        () -> assertEquals(AzureWebAppLinuxRuntimeStack.fromString("NODE|20-lts"), AzureWebAppLinuxRuntimeStack.NODE_20_LTS),
        ...
        () -> assertEquals(AzureWebAppLinuxRuntimeStack.fromString("PYTHON|3.12"), AzureWebAppLinuxRuntimeStack.PYTHON_3_12),
        ...
        () -> assertEquals(AzureWebAppLinuxRuntimeStack.fromString("JBOSSEAP|7-java17"), AzureWebAppLinuxRuntimeStack.JBOSS_EAP_7_JAVA_17),
        ...
        () -> assertEquals(AzureWebAppLinuxRuntimeStack.fromString("TOMCAT|10.1-java17"), AzureWebAppLinuxRuntimeStack.TOMCAT_10_1_JAVA_17),
        () -> assertEquals(AzureWebAppLinuxRuntimeStack.fromString("TOMCAT|10.1-java11"), AzureWebAppLinuxRuntimeStack.TOMCAT_10_1_JAVA_11),
