...
class AzurePostgreSQLDBTest {
  ...
  public void validationError_when_dbWithNullName() {
    ...
    assertThatThrownBy(db::build).isInstanceOf(IllegalArgumentException.class).hasMessageContaining(
      "[AzurePostgreSqlDatabase Validation] name has not been defined and it is required");
  }
  ...
  public void validationError_when_dbWithBlankCollation() {
    ...
    assertThatThrownBy(db::build).isInstanceOf(IllegalArgumentException.class).hasMessageContaining("PostgreSQLDB " +
      "collation defined was either empty or blank and it is required");
  }
  ...
  public void validationError_when_dbWithBlankSchema() {
    ...
    assertThatThrownBy(db::build).isInstanceOf(IllegalArgumentException.class).hasMessageContaining("PostgreSQLDB " +
      "schema defined was either empty or blank and it is required");
  }
