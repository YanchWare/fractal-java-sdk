...
import com.yanchware.fractal.sdk.domain.fractal.iaas.DnsAaaaRecord;
import com.yanchware.fractal.sdk.domain.fractal.iaas.DnsPtrRecord;
...
class OperationalEnvironmentTest {
  ...
  private static final ResourceGroupId VALID_RESOURCE_GROUP_ID = ResourceGroupId.fromString(String.format("Personal" +
    "/%s/rg", VALID_OWNER_ID));
  ...
  void exceptionThrown_when_environmentCreatedWithEmptyCiCdProfileShortName() {
    assertThatThrownBy(() -> generateBuilder(VALID_SHORT_NAME)
      ...
      .build())
      .isInstanceOf(IllegalArgumentException.class)
      .hasMessageContaining("The Short Name only allow alphanumeric characters and hyphens, cannot start or end in a " +
        "hyphen"); // Assuming SHORT_NAME_NOT_VALID is your validation message
  }
