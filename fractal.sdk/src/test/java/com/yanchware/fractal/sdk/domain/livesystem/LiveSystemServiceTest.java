...
public class LiveSystemServiceTest {
  ...
  public void urlPathMatching_when_getRequestToLiveSystemMutation(WireMockRuntimeInfo wmRuntimeInfo) throws InstantiatorException {
    ...
    stubFor(get(urlPathMatching("/livesystems/resourceGroupId/livesystem-name/mutations/mutation-id"))
      .willReturn(aResponse()
        .withStatus(200)
        .withBody("{\"liveSystemId\":\"fancy-group/CompanyCloud\",\"id\":\"a09f1ca7-5ee8-4d53-a187-644146d19479\"," +
          "\"status\":\"Completed\",\"created\":\"2023-04-13T23:24:29.503384+00:00\"," +
          "\"lastUpdated\":\"2023-04-13T23:24:29.503384+00:00\",\"componentsReadyIds\":[\"company-cloud\"," +
          "\"relational-dbms-platform\"],\"componentsCompletedIds\":[],\"componentsFailedIds\":[]," +
          "\"componentsById\":{\"company-cloud\":{\"status\":\"Instantiating\"," +
          "\"outputFields\":{\"cluster\":{\"abc\":123}},\"lastUpdated\":\"2023-04-13T23:24:30.948156+00:00\"," +
          "\"lastOperationRetried\":0,\"provider\":\"Azure\",\"lastOperationStatusMessage\":\"\"," +
          "\"displayName\":\"AKS instantiation\",\"description\":\"Cloud AKS cluster\",\"type\":\"NetworkAndCompute" +
          ".PaaS.ContainerPlatform\",\"id\":\"company-cloud\",\"version\":\"1.0\"," +
          "\"parameters\":{\"region\":\"westeurope\",\"network\":\"network-host\"," +
          "\"nodePools\":[{\"name\":\"linuxdynamic\",\"osType\":\"LINUX\",\"maxSurge\":1,\"diskSizeGb\":128," +
          "\"machineType\":\"STANDARD_B4MS\",\"maxNodeCount\":9,\"minNodeCount\":1,\"agentPoolMode\":\"SYSTEM\"," +
          "\"maxPodsPerNode\":30,\"initialNodeCount\":1},{\"name\":\"windyn\",\"osType\":\"WINDOWS\",\"maxSurge\":1," +
          "\"diskSizeGb\":128,\"machineType\":\"STANDARD_B4MS\",\"maxNodeCount\":9,\"minNodeCount\":1," +
          "\"agentPoolMode\":\"USER\",\"maxPodsPerNode\":30,\"initialNodeCount\":1}],\"podsRange\":\"tier-1-pods\"," +
          "\"subNetwork\":\"compute-tier-1\",\"serviceRange\":\"tier-1-services\"},\"dependencies\":[],\"links\":[]}," +
          "\"company-controller\":{\"status\":\"Instantiating\",\"outputFields\":{}," +
          "\"lastUpdated\":\"2023-04-13T23:24:30.948169+00:00\",\"lastOperationRetried\":0,\"provider\":\"Azure\"," +
          "\"lastOperationStatusMessage\":\"\",\"displayName\":\"Company controller\",\"description\":\"Company " +
          "controller\",\"type\":\"CustomWorkloads.Caas.K8sWorkload\",\"id\":\"company-controller\",\"version\":\"1" +
          ".0\",\"parameters\":{\"roles\":[],\"repoId\":\"Company.Cloud/Company.Cloud.Controller\"," +
          "\"namespace\":\"company-cloud\",\"sshRepositoryURI\":\"git@ssh.dev.azure.com:v3/CompanyCloud/Company" +
          ".Cloud/Company.Cloud.Controller\",\"containerPlatform\":\"company-cloud\"," +
          "\"privateSSHKeySecretId\":\"fractalDeployerSshKey\"," +
          "\"privateSSHKeyPassphraseSecretId\":\"fractalDeployerSshKeyPassphrase\"}," +
          "\"dependencies\":[\"company-cloud\"],\"links\":[]}," +
          "\"relational-dbms-platform\":{\"status\":\"Instantiating\",\"outputFields\":{}," +
          "\"lastUpdated\":\"2023-04-13T23:24:30.948178+00:00\",\"lastOperationRetried\":0,\"provider\":\"Azure\"," +
          "\"lastOperationStatusMessage\":\"\",\"displayName\":\"Relational DBMS Platform\"," +
          "\"description\":\"Platform providing RDBMS as a service\",\"type\":\"DataStorage.PaaS.PostgreSQL\"," +
          "\"id\":\"relational-dbms-platform\",\"version\":\"1.0\",\"parameters\":{\"tier\":\"GP_Gen5_4\"," +
          "\"region\":\"westeurope\",\"version\":\"11\",\"storageAutoResize\":true},\"dependencies\":[]," +
          "\"links\":[]}},\"componentsBlocked\":{\"company-cloud\":[\"company-controller\"]}}")
        .withHeader("Content-Type", "application/json")));
